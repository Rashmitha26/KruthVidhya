...
public class nine extends AppCompatActivity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paintView = (PaintView) findViewById(R.id.paintView9);
        ...
        switch (requestCode) {
            case REQUEST_RECORD_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(nine.this, "Permission Denied!", Toast
                            .LENGTH_SHORT).show();
                }
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.logout:
                ...
                finish();
                startActivity(new Intent(nine.this, MainActivity.class));
        }
    ...
    public void onResults(Bundle results) {
        ...
        Toast.makeText(nine.this,fromOCR+" "+fromSTT,Toast.LENGTH_SHORT).show();
    ...
    public void check(String x,String y){
        ...
        if(x.equals(sb.toString()) && x.equals("joker")) score++;
        Intent i=new Intent(nine.this,result.class);
