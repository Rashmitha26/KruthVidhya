...
public class sixth extends AppCompatActivity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paintView = (PaintView) findViewById(R.id.paintView6);
        ...
        switch (requestCode) {
            case REQUEST_RECORD_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(sixth.this, "Permission Denied!", Toast
                            .LENGTH_SHORT).show();
                }
        }
    }
    ...
    public void onResults(Bundle results) {
        ...
        Toast.makeText(sixth.this,fromOCR+" "+fromSTT,Toast.LENGTH_SHORT).show();
    ...
    public void check(String x,String y){
        ...
        if(x.equals(sb.toString()) && x.equals("gun")) score++;
