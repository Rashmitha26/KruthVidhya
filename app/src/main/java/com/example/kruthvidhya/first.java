...
public class first extends AppCompatActivity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //demoRef.push().setValue(firebaseAuth.getCurrentUser().getDisplayName());
        ...
        switch (requestCode) {
            case REQUEST_RECORD_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(first.this, "Permission Denied!", Toast
                            .LENGTH_SHORT).show();
                }
        }
    }
    ...
    public void onResults(Bundle results) {
        ...
        //Toast.makeText(first.this,fromOCR+" "+fromSTT,Toast.LENGTH_SHORT).show();
    ...
    public void check(String x,String y){
        ...
        if(x.contains(y) && y.equals("bat")) score++;
        demoRef.push().setValue(firebaseAuth.getCurrentUser().getDisplayName());
